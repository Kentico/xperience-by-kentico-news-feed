...
export interface ProductNewsFeedItem {
  heading: string;
...
interface ProductNewsFeedCardProps {
  item: ProductNewsFeedItem;
}

export const ProductNewsFeedCard = ({ item }: ProductNewsFeedCardProps) => {
  return (
